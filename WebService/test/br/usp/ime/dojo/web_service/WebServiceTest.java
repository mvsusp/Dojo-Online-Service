...
public class WebServiceTest {
	...
	public void aRubyScriptWithUnitTest() {
		String result = submitPost("ruby", readScript("ruby/sourceScriptWithUnitTest.rb"), readScript("ruby/testScriptWithUnitTest.rb"));
	...
	private String submitPost(String language, String sourceCode, String testCode){
	...
	private String submitGet(String language, String sourceCode, String testCode){
		HashMap<String,String> parameters = new HashMap<String,String>();
		parameters.put("input.sourceCode", sourceCode);
		parameters.put("input.language", language);		
		parameters.put("input.testCode", testCode);
